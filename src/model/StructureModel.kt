...
class StructureModel {
	...
	init {
		...
		// E L E M E N T S //
		/////////////////////
		val e1 = Element(1, n1, n3, m1, s1, false, false)
		val e2 = Element(2, n2, n5, m1, s1, false, false)
		val e3 = Element(3, n3, n4, m1, s1, false, true)
		val e4 = Element(4, n3, n5, m1, s1, false, false, DistributedLoad(0.0, -12.0, true))
		val e5 = Element(5, n4, n6, m1, s1, true, false, DistributedLoad(-10.0, -20.0, -10.0, -20.0, false))
		val e6 = Element(6, n6, n5, m1, s1, false, false)
		mElements.add(e1)
		mElements.add(e2)
		mElements.add(e3)
		mElements.add(e4)
...
//        val n4 = Node(4, 7.0, 7.0, arrayOf(FREE, FREE, FREE), doubleArrayOf(0.0, -45.6946, 0.0))
		...
		val load = DistributedLoad(0.0, -200.0, isLocalLoad = false)
		
		val e1 = Element(1, n2, n3, m1, s1, hasHingeBegin = false, hasHingeEnd = true)
		val e2 = Element(2, n3, n4, m1, s1, hasHingeBegin = true, hasHingeEnd = true, load = load)
